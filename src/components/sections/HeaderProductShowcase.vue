<template>
    <b-navbar toggleable="xl" fixed="top" v-b-scrollspy:nav-scroller class="header-area product-shocase-header" :class="{'is-sticky': scrolled}">
        <div class="container-fluid container-fluid--cp-150">
            ...
            <b-collapse class="default-nav justify-content-center"  is-nav id="nav_collapse">
                <b-navbar-nav class="navbar-nav main-menu text-white">
                    ...
                    <b-nav-item href="#product" class="scroll"><span>PRODUCT</span></b-nav-item>
                    <b-nav-item href="#video" class="scroll"><span>VIDEO INTRO</span></b-nav-item>
